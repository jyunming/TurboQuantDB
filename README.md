...
|---|---:|---:|---:|---:|---:|---:|---:|
| b=2 rerank=F | 88,000 | 1.1s | 16.8 | 31 | 10.29 | 13.35 | 0.502 |
| b=2 rerank=T | 89,563 | 1.1s | 16.8 | 24 | 13.82 | 16.17 | 0.666 |
| b=4 rerank=F | 51,513 | 1.9s | 22.9 | 24 | 11.67 | 13.88 | 0.842 |
| b=4 rerank=T | 62,537 | 1.6s | 22.9 | 25 | 13.99 | 16.31 | 0.900 |
...
| Config | @k=1 | @k=2 | @k=4 | @k=8 | @k=16 | @k=32 | @k=64 |
|---|---:|---:|---:|---:|---:|---:|---:|
| TQDB b=2 rerank=F ANN | 10.0% | 13.0% | 15.6% | 17.7% | 19.2% | 19.8% | 20.1% |
| TQDB b=2 rerank=T ANN | 20.1% | 25.4% | 29.1% | 31.2% | 32.1% | 32.3% | 32.3% |
| TQDB b=4 rerank=F ANN | 21.1% | 24.4% | 25.8% | 26.2% | 26.3% | 26.3% | 26.3% |
| TQDB b=4 rerank=T ANN | 34.6% | 38.3% | 39.4% | 39.6% | 39.6% | 39.6% | 39.6% |

*Performance — ANN:*

| Config | Thruput vps | Ingest | Index | Disk MB | ΔRSS MB | p50 ms | p99 ms | MRR |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| b=2 rerank=F ANN | 82,076 | 1.2s | 4.6s | 16.8 | 24 | 5.34 | 8.35 | 0.128 |
| b=2 rerank=T ANN | 88,992 | 1.1s | 3.9s | 16.8 | 27 | 8.10 | 10.73 | 0.243 |
| b=4 rerank=F ANN | 54,162 | 1.8s | 3.6s | 22.9 | 28 | 5.27 | 8.16 | 0.232 |
| b=4 rerank=T ANN | 63,281 | 1.6s | 3.7s | 22.9 | 28 | 8.12 | 10.32 | 0.368 |
...
| Config | Thruput vps | Ingest | Disk MB | ΔRSS MB | p50 ms | p99 ms | MRR |
|---|---:|---:|---:|---:|---:|---:|---:|
| b=2 rerank=F | 26,462 | 3.8s | 59.5 | 119 | 28.68 | 32.51 | 0.882 |
| b=2 rerank=T | 25,241 | 4.0s | 59.5 | 71 | 35.82 | 47.58 | 0.926 |
| b=4 rerank=F | 10,759 | 9.3s | 108.3 | 173 | 45.67 | 52.29 | 0.961 |
| b=4 rerank=T | 13,379 | 7.5s | 108.3 | 167 | 51.31 | 58.95 | 0.977 |
...
| Config | @k=1 | @k=2 | @k=4 | @k=8 | @k=16 | @k=32 | @k=64 |
|---|---:|---:|---:|---:|---:|---:|---:|
| TQDB b=2 rerank=F ANN | 57.8% | 65.7% | 68.7% | 69.2% | 69.3% | 69.3% | 69.3% |
| TQDB b=2 rerank=T ANN | 73.1% | 80.2% | 82.7% | 83.2% | 83.2% | 83.2% | 83.2% |
| TQDB b=4 rerank=F ANN | 66.6% | 70.2% | 70.7% | 70.8% | 70.8% | 70.8% | 70.8% |
| TQDB b=4 rerank=T ANN | 80.4% | 83.6% | 83.9% | 83.9% | 83.9% | 83.9% | 83.9% |

*Performance — ANN:*

| Config | Thruput vps | Ingest | Index | Disk MB | ΔRSS MB | p50 ms | p99 ms | MRR |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| b=2 rerank=F ANN | 25,586 | 3.9s | 19.6s | 59.5 | 83 | 7.16 | 10.26 | 0.628 |
| b=2 rerank=T ANN | 24,092 | 4.2s | 19.2s | 59.5 | 126 | 21.27 | 28.96 | 0.775 |
| b=4 rerank=F ANN | 9,695 | 10.3s | 18.4s | 108.3 | 131 | 7.28 | 10.75 | 0.686 |
| b=4 rerank=T ANN | 14,388 | 7.0s | 19.1s | 108.3 | 99 | 23.37 | 32.06 | 0.821 |
...
| Config | Thruput vps | Ingest | Disk MB | ΔRSS MB | p50 ms | p99 ms | MRR |
|---|---:|---:|---:|---:|---:|---:|---:|
| b=2 rerank=F | 7,567 | 13.2s | 108.3 | 196 | 69.96 | 81.24 | 0.913 |
| b=2 rerank=T | 13,066 | 7.7s | 108.3 | 209 | 81.62 | 136.90 | 0.943 |
| b=4 rerank=F | 5,991 | 16.7s | 206.0 | 304 | 81.33 | 94.39 | 0.972 |
| b=4 rerank=T | 5,178 | 19.3s | 206.0 | 339 | 92.88 | 107.73 | 0.980 |
...
| Config | @k=1 | @k=2 | @k=4 | @k=8 | @k=16 | @k=32 | @k=64 |
|---|---:|---:|---:|---:|---:|---:|---:|
| TQDB b=2 rerank=F ANN | 62.6% | 69.1% | 71.0% | 71.5% | 71.5% | 71.5% | 71.5% |
| TQDB b=2 rerank=T ANN | 75.0% | 82.8% | 83.4% | 83.6% | 83.6% | 83.6% | 83.6% |
| TQDB b=4 rerank=F ANN | 68.7% | 71.0% | 71.3% | 71.3% | 71.3% | 71.3% | 71.3% |
| TQDB b=4 rerank=T ANN | 82.6% | 85.1% | 85.1% | 85.1% | 85.1% | 85.1% | 85.1% |

*Performance — ANN:*

| Config | Thruput vps | Ingest | Index | Disk MB | ΔRSS MB | p50 ms | p99 ms | MRR |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| b=2 rerank=F ANN | 12,878 | 7.8s | 34.0s | 108.3 | 133 | 8.68 | 13.87 | 0.665 |
| b=2 rerank=T ANN | 12,245 | 8.2s | 33.5s | 108.3 | 209 | 35.14 | 50.30 | 0.791 |
| b=4 rerank=F ANN | 7,159 | 14.0s | 32.2s | 206.0 | 304 | 9.28 | 14.87 | 0.700 |
| b=4 rerank=T ANN | 4,783 | 20.9s | 32.2s | 206.0 | 303 | 40.02 | 58.65 | 0.839 |
